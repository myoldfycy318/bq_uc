...
public enum ErrorCode 
{
	...
	PASSWORD_FAIL("-81", "密码修改异常，请稍后重试"),
	//------------------------第三方错误码-------------------------//保留-86到-95
	BIND_FAIL("-86", "绑定失败,请重试"),
	BIND_PASSPORT_EXIST("-87", "仅可绑定未注册账号"),
	HAS_BIND("-88", "账号已绑定"),
	BIND_SAME_TYPE("-89","不可绑定相同类型账号"),
	//------------------------开放平台错误码-------------------------//保留-96到-105
	...
	NAME_ILLEGLE("-123", "请输入2-6个汉字姓名"),
	NAME_NOT_NULL("-124", "姓名不能为空"),
	DECRYPT_FAIL("-125","解密失败，请确定加密信息"),
	;
