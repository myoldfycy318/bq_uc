...
public interface UserCenterConstants {
     ...
     * redis缓存中应用前缀：
     */
    public static final String REDIS_USERCENTER_APPLICATION = "uc:";
     ...
     */
    public static final int SMS_EMAIL_TOKEN_TIME = 1 * 60 * 60;
     ...
     * 邮件预警收件人地址
     */
    public static final String EMAIL_RECIPIENT = "mail.recipient";
    ...
    /**
     * 邮件验证码过期时间 2017-6-13改邮箱验证码缓存为2小时
     */
    public static final int EMAIL_CODE_EXPIRE_TIME = 60 * 60 * 2;
     ...
     * 冰穹用户openId
     */
    public static final String DOME_USER_OPENID = "openId";

    /**
     * 冰穹用户third
     */
    public static final String DOME_USER_THIIRDID = "thirdId";
