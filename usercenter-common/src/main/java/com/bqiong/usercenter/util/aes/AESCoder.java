...
public class AESCoder
{
	...
	public static byte[] decrypt(byte[] content, String salt) {  
        ...
        {
        		log.info("消息解密失败！", e);
                throw new BizException(ErrorCode.DECRYPT_FAIL.getCode());
        }
	}  
	...
	{
		String oripwd = "RDAwMDEyODQ|YnFfMDAwMDAwMDYw|1493969511774|0515957e641f49450de2f699b323c98a";
...
//		System.out.println("解密后：" + new String(decryptResult));  
		...
		System.out.println(getEncryptResult("111111","1qaz!@#$"));
